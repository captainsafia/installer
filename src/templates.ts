...
\`\`\`bash
curl https://i.captainsafia.sh/junegunn/fzf | sh
\`\`\`

Install a specific version:
\`\`\`bash
curl https://i.captainsafia.sh/junegunn/fzf/v0.55.0 | sh
\`\`\`
...
\`\`\`bash
curl https://i.captainsafia.sh/<owner>/<repo>/pr/<number> | sh
\`\`\`
...
#
# Usage: irm https://i.captainsafia.sh/${result.user}/${result.program} | iex
# Usage with specific release: $env:RELEASE='${result.release}'; irm https://i.captainsafia.sh/${result.user}/${result.program} | iex
